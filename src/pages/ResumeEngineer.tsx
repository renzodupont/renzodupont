          ...
          <section className="resume-section" id="experience">
            ...
            <div className="employer">
              ...
              <div className="employer-roles">
                ...
                <ul>
                  <li>Building generative AI features for a digital marketing platform using TypeScript on Cloudflare (Workers, Pages, D1, R2, KV) with multiple LLM providers</li>
                </ul>
              </div>
            </div>
